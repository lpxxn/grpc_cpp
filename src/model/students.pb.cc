...
extern PROTOBUF_INTERNAL_EXPORT_students_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Student_students_2eproto;
namespace model {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Student_students_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Student_students_2eproto}, {}};

static void InitDefaultsscc_info_StudentList_students_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_StudentList_students_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_StudentList_students_2eproto}, {
      &scc_info_Student_students_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_students_2eproto[2];
...
const char descriptor_table_protodef_students_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016students.proto\022\005model\"0\n\007Student\022\n\n\002id"
  "\030\001 \001(\003\022\014\n\004name\030\002 \001(\t\022\013\n\003age\030\003 \001(\005\"^\n\013Stu"
  "dentList\022\r\n\005class\030\001 \001(\t\022 \n\010students\030\002 \003("
  "\0132\016.model.Student\022\017\n\007teacher\030\003 \001(\t\022\r\n\005sc"
  "ore\030\004 \003(\003B5\n\017com.proto.modelZ\"github.com"
  "/grpc_study/protos/modelb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_students_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_students_2eproto_sccs[2] = {
  &scc_info_Student_students_2eproto.base,
  &scc_info_StudentList_students_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_students_2eproto = {
  false, false, descriptor_table_protodef_students_2eproto, "students.proto", 232,
  &descriptor_table_students_2eproto_once, descriptor_table_students_2eproto_sccs, descriptor_table_students_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_students_2eproto::offsets,
  file_level_metadata_students_2eproto, 2, file_level_enum_descriptors_students_2eproto, file_level_service_descriptors_students_2eproto,
};
...
void StudentList::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_StudentList_students_2eproto.base);
  class__.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  teacher_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
